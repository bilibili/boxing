...
interface IBoxingMediaLoader {
     ...
     */
    fun displayThumbnail(img: ImageView, absPath: String, width: Int, height: Int)
     ...
     */
    fun displayRaw(img: ImageView, absPath: String, width: Int, height: Int, callback: IBoxingCallback?)
}
